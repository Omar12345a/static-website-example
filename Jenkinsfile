...
pipeline {
     environment {
       ...
       APP_NAME = "Omar"
       STG_API_ENDPOINT = "http://ip10-0-0-3-cka1imst654gqaevkdmg-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "http://ip10-0-0-3-cka1imst654gqaevkdmg-80.direct.docker.labs.eazytraining.fr/"
       PROD_API_ENDPOINT = "'http://ip10-0-0-4-cka1imst654gqaevkdmg-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "'http://ip10-0-0-4-cka1imst654gqaevkdmg-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
