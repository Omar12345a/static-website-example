...
pipeline {
     environment {
       ...
       PROD_API_ENDPOINT = "http://ip10-0-1-4-cka4l5st654gqaevke10-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "http://ip10-0-1-4-cka4l5st654gqaevke10-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
